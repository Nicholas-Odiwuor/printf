 ...
 * @c: Char types.
 * @buffer: Buffer -rray to handle print
...
{ /* char is stored to the left and padded to the buffer's right */
	int i = 0;
	char padd = ' ';
...
/**
 * write_unsgnd - Writes an un-signed number
...
int write_unsgnd(int is_negative, int ind,
	...
	int flags, int width, int precision, int size)
{
	/* Number is stored to the buffer's right and starts at position i */
